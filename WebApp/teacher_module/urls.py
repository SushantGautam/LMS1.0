...
urlpatterns += (
     ...
     path('activate_quiz/<int:pk>/', quizViews.ActivateQuiz.as_view(), name='teacher_activate_quiz'),
     path('deactivate_quiz/<int:pk>/', quizViews.DeactivateQuiz.as_view(), name='teacher_deactivate_quiz'),
)
